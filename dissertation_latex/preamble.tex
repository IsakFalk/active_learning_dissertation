...
\begin{abstract} % 300 word limit
  ...
  the empirical risk of the estimator trained on the built train set. We analyse
  the generalisation performance of this algorithm and proceed to bound the excess
  risk but current results from convergence of Frank Wolfe means we cannot say
  whether or not this improves upon random sampling in theory.
  ...
  learning in practice. We also show that it performs better than the other methods in the
  agnostic setting of both regression and classification.

  % Conclusion
  This shows that using Frank Wolfe to mitigate domain drift when doing active
  learning for regression is competitive and
  ...
  realisable setting. Finally we discuss future work of analysing performance of the
  algorithm in the noise setting and the potential to use random projections and
  subsampling inside of the Frank Wolfe iteration to lower computational and
